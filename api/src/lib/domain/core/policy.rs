...
use crate::{
    ...
    domain::{
        client::{
            entities::model::Client, ports::client_service::ClientService,
            services::client_service::DefaultClientService,
        },
        realm::entities::realm::Realm,
        role::entities::{models::Role, permission::Permissions},
        user::{
            entities::model::User, ports::user_service::UserService,
...
impl PolicyEnforcer {
    pub fn new(user_service: DefaultUserService, client_service: DefaultClientService) -> Self {
        Self {
            user_service,
            client_service,
        }
