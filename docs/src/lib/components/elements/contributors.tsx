...
export default function Contributors() {
    return (
        <div className="py-20">
            <div>
                <h2 className="text-34l text-balance font-semibold tracking-tight text-gray-900 sm:text-5xl">Contributors</h2>
                <p className="mt-6 text-md text-gray-600 max-w-2xl">
                    FerrisKey is not possible without the help and support of our outstanding contributors.
                </p>
            </div>
